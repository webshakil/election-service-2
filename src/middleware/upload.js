...
export const upload = multer({
  ...
  fileFilter,
  limits: {
    fileSize: Infinity,        // NO LIMIT - Maximum possible
    fieldSize: Infinity,       // NO LIMIT - Maximum possible (THIS FIXES YOUR ERROR)
    fields: Infinity,          // NO LIMIT - Maximum possible
    fieldNameSize: Infinity,   // NO LIMIT - Maximum possible
    headerPairs: Infinity,     // NO LIMIT - Maximum possible
    parts: Infinity            // NO LIMIT - Maximum possible
  }
});
  ...
  if (err instanceof multer.MulterError) {
    ...
    if (err.code === 'LIMIT_FIELD_VALUE') {
      return res.status(400).json({
        ...
        error: `The field '${err.field}' contains too much data.`
      });
    }
  }
...
//this is the last workable file. to increase file size above code
// import multer from 'multer';
// import { FILE_UPLOAD_LIMITS } from '../config/constants.js';
